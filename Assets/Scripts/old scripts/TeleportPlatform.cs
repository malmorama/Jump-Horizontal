...
//old script, this logic is in the TeleportCoroutine script that is triggered via event from player logic and attached to OnScreenCoroutinegameobj
//as Corouintes stop as gameobg is set inactive
